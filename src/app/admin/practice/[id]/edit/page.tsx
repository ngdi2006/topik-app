    ...
    return (
        <div className="max-w-4xl mx-auto space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Chỉnh Sửa Kịch Bản AI</h1>
                    <p className="text-gray-600 mt-1">{formData.scenario_title}</p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setFormData({ ...formData, scenario_title_korean: e.target.value || null })}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            onChange={(e) => setFormData({ ...formData, context: e.target.value || null })}
                            rows={3}
                            className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                        />
                    </div>
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6 space-y-4">
                    ...
                    {formData.sample_dialogue.length === 0 && (
                        <p className="text-sm text-gray-500 text-center py-4">
                            Chưa có hội thoại mẫu. Nhấn "Thêm câu" để bắt đầu.
                        </p>
                    )}
                </div>
