...
BẮT BUỘC TRẢ VỀ ĐÚNG ĐỊNH DẠNG JSON MẪU DƯỚI ĐÂY (dùng dấu nháy kép chuẩn, không chứa ký tự ngoặc nhọn/vuông linh tinh làm hỏng JSON):
{
...
Lưu ý: "score" là số nguyên từ 0 đến 100.
`;
        ...
        try {
            ...
            console.error("JSON Parse Error. Raw Gemini Response:", textResponse);
            return NextResponse.json({ error: "Lỗi phản hồi AI. Vui lòng thử lại. Dữ liệu gốc: " + textResponse }, { status: 500 });
        }
